...
if (!customElements.get("sticky-atc")) {
  customElements.define("sticky-atc", class StickyAtc extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this.mainATCButton = (_this$mainProduct = this.mainProduct) === null || _this$mainProduct === void 0 ? void 0 : _this$mainProduct.querySelector(this.selectors.atc);
      this.mainProductDynamic = (_this$mainProduct2 = this.mainProduct) === null || _this$mainProduct2 === void 0 ? void 0 : _this$mainProduct2.querySelector(this.selectors.buyNowBtn);
    ...
    init() {
      ...
      if (buyNowBtn) this.enable_dynamic_checkout = true; // const isMobile = window.matchMedia("(max-width: 639px)");
      ...
      prodTitle === null || prodTitle === void 0 ? void 0 : prodTitle.addEventListener("click", window.MinimogLibs.scrollToTop);
      mainImage === null || mainImage === void 0 ? void 0 : mainImage.addEventListener("click", window.MinimogLibs.scrollToTop);
          ...
          buyNowBtn.addEventListener("click", e => {
            ...
            if (missing.length > 0) {
              ...
              window.MinimogLibs.scrollToTop(() => {
                var _this$mainProductDyna;

                return (_this$mainProductDyna = this.mainProductDynamic) === null || _this$mainProductDyna === void 0 ? void 0 : _this$mainProductDyna.click();
              });
            }
          }, true);
        }
