  ...
  initFlashSale: async function () {
    ...
    if (res.ok && res.payload && res.payload.length) {
      ...
      this.domNodes.products.forEach(card => {
        ...
        const content = card.querySelector('.sf__pcard-content');
        const soldNumber = (_card$dataset2 = card.dataset) === null || _card$dataset2 === void 0 ? void 0 : _card$dataset2.soldNumber; // const component = <SaleProgress settings={res.payload[0]} productId={card.dataset.productId} soldNumber={soldNumber} />
