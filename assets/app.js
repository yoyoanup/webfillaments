  ...
  constructor(productForm) {
    ...
    _defineProperty(this, "initOptions", () => {
      ...
      this.domNodes.optionNodes.forEach(optNode => {
        ...
        const customColor = (_colorSwatches$find = _colorSwatches.find(c => c.key === optionValueLowerCase)) === null || _colorSwatches$find === void 0 ? void 0 : _colorSwatches$find.value; // if (variantImage || customImage) optNode.classList.add('has-bg-img')
...
function initTheme() {
  ...
  (0,theme_sections/* load */.zD)('product-tabs'); // loadAllSections()
}
